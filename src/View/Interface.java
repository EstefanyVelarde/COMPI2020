...
import Control.AnalizadorSintactico;
import Control.XLS;
...
public class Interface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        background.setMaximumSize(new java.awt.Dimension(1960, 1080));
        background.setMinimumSize(new java.awt.Dimension(1960, 1080));
        background.setPreferredSize(new java.awt.Dimension(1960, 1080));
        ...
        sidePanelLayout.setVerticalGroup(
            ...
            .addGroup(sidePanelLayout.createSequentialGroup()
                ...
                .addGroup(sidePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(contadoresScroll, javax.swing.GroupLayout.DEFAULT_SIZE, 794, Short.MAX_VALUE)
            ...
            .addGroup(backgroundLayout.createSequentialGroup()
                ...
                .addGroup(backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(backgroundLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(codigoScroll, javax.swing.GroupLayout.PREFERRED_SIZE, 632, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(downPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addGap(53, 53, 53))
        );
    ...
    private void jbCompileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCompileActionPerformed
        ...
        analizadorLexico.leer(codigo.getText());
        
        if(!analizadorLexico.getTokens().isEmpty()) {
            analizadorSintactico = new AnalizadorSintactico(analizadorLexico.getTokensCopy(), analizadorLexico.getErrores());
        
            analizadorSintactico.analizarTokens();
        }
        
        analizadorLexico.setTablas(tokens, errores, contadores);
    ...
    private void jbXLSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbXLSActionPerformed
        XLS ce = new XLS(analizadorLexico.getTokensCopy(), analizadorLexico.getErrores(), analizadorLexico.getContadores(), analizadorLexico.getLinea());
        ce.crearExcel();
