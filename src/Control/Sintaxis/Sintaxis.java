...
public class Sintaxis {
    ...
    int prod[][] = {
        {0, 1, -96}, // S0 -> PROGRAM $
        {1, 2, 80110, 800, -46, 36, 5, -47, 801, 80111}, // PROGRAM -> A0 @ { EST A3 } @ @
        ...
        {30, -54}, // J0 -> ++
        {30, -55}, // J0 -> --
        {31, 860, 24, 861, 32}, // J1 -> @ ARR @ J2
        {31, 851, 28, 33, 852}, // J1 -> @ ASIGN J3 @
        {31, 845, -44, 35, -45, 846}, // J1 -> @ ( J5 ) @
        {31, -54}, // J1 -> ++
        {31, -55}, // J1 -> --
        {31, -52, 869, 48}, // J1 -> . @ FUNLIST
        {32,  851, 28, 33, 852}, // J2 -> @ ASIGN J3 @
        {33, 20}, // J3 -> OR
        {33, -94, -44, 34, -45}, // J3 -> input ( J4 ) 
        {34, -4}, // J4 -> ConstCadena
        {35, 20, 870, 9}, // J5 -> OR @ B0
        {36, -81, -44, 20, 870, 9, -45}, // EST -> print ( OR B0 )
        ...
        {49, -79, -44, 35, -45, 872}, // FUNCIONES -> variance ( J5 )
